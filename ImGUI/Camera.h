...
public:
	Camera();
	~Camera();
	bool Initialize(HINSTANCE hInstance, HWND hwnd,Input *input, int width, int height, XMFLOAT3 eye = XMFLOAT3(0.0f, 1.0f, -5.0f), XMFLOAT3 at = XMFLOAT3(0.0f, 1.0f, 0.0f));
	void Frame();


public:
	XMMATRIX GetViewMatrix();
	XMMATRIX GetViewConstMatrix();
